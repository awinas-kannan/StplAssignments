		...
		<div id="accessdiv" style="display: block">
			<table>
				<tr>
					...
					<th><input type="button" id="editformbutton"
						name="EDITformbutton" value="EDIT STUDENT DETAIL"
						onclick="showeditform()"></th>
				</tr>
			</table>
		</div>
	</center>
		...
		<div id="editdiv" style="display: none">
			<form action="edit" method="post">
				<table>
					<tr>
						<td><label>ENTER STUDENT ID</label></td>
						<td><input type="number" id="editid" name="editid"></td>
					</tr>
					<tr>
						<th colspan="2"><input type="submit"
							value="EDIT STUDENT DETAIL"></th>
					</tr>
				</table>
			</form>
		</div>
