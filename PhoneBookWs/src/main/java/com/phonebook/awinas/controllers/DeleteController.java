...
public class DeleteController {
	...
	@RequestMapping(value = PBUrlConstants.GTN_WS_PB_DELETECONTACT_SERVICE, method = RequestMethod.POST)
	public GtnUIFrameworkWebserviceResponse delcon(@RequestBody GtnUIFrameworkWebserviceRequest request) {

		logger.info("del contact controller called");
